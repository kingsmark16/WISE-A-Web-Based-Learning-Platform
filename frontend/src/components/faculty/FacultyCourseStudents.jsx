          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-[20%] text-center">Progress</TableHead>
                <TableHead className="w-[20%] text-center">Last Active</TableHead>
                <TableHead className="w-[20%] text-center">Quiz Results</TableHead>
                <TableHead className="w-[10%] text-center">View Results</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {[1, 2, 3].map((i) => (
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div className="overflow-x-auto">
          ...
          <TableHeader className="bg-muted/50">
            <TableRow>
              <TableHead className="w-[30%] font-semibold text-sm py-3 text-left text-foreground">Student Name</TableHead>
              <TableHead className="w-[20%] text-center font-semibold text-sm py-3 text-foreground">Progress</TableHead>
              <TableHead className="w-[20%] text-center font-semibold text-sm py-3 text-foreground">Last Active</TableHead>
              <TableHead className="w-[20%] text-center font-semibold text-sm py-3 text-foreground">Quiz Results</TableHead>
              <TableHead className="w-[10%] text-center font-semibold text-sm py-3 text-foreground">View Results</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {students.length > 0 ? (
                ...
                <TableRow key={student.id} className="hover:bg-primary/5 transition-all duration-200 hover:shadow-sm">
                  ...
                  <TableCell className="py-4 px-6 text-center text-base">
                    <div className="flex flex-col items-center gap-1">
                      <span className="text-sm font-medium">
                        {student.progress.quizzesCompleted || 0} Completed
                      </span>
                    </div>
                  </TableCell>
                  <TableCell className="py-4 px-6 text-center">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex items-center gap-2 mx-auto hover:bg-primary/10"
