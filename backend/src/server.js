...
//Stricter rate limits for video uploads
app.use("/api/upload", requireAuth(), strictRateLimit("1m", 5), uploadRoutes);
app.use("/api/youtube-lessons", requireAuth(), strictRateLimit("1m", 5), youtubeVideoRoutes);
